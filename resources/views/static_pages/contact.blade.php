...
@section('title', trans('content.contact'))
                ...
                <div class="col-lg-3">
                    <div class="contact_info">
                        <div class="info_item">
                            ...
                            <h6>@lang('Sun* Inc')</h6>
                            <p>@lang('Education Vietnam Unit (EVU)')</p>
                        </div>
                        <div class="info_item">
                            <i class="lnr lnr-phone-handset"></i>
                            <h6><a href="#">@lang('00 (440) 9865 562')</a></h6>
                            <p>@lang('Mon to Fri 9am to 6 pm')</p>
                        </div>
                        <div class="info_item">
                            <i class="lnr lnr-envelope"></i>
                            <h6><a href="#">@lang('support@colorlib.com')</a></h6>
                            <p>@lang('Send us your query anytime!')</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-9">
                    <form class="row contact_form" action="contact_process.php" method="post" id="contactForm"
                        ...
                        <div class="col-md-12 text-right">
                            <button type="submit" value="submit" class="primary-btn">@lang('Send Message')</button>
                        </div>
                    </form>
                </div>
            </div>
